...
if (!defined $opts{i} || !defined $opts{o} || !defined $opts{q} ) {
	die "************************************************************************
	Usage: $0.pl -i Single_estimated_insertion.txt -q quality file of each reads -o Unique insertions output string -s aligned shift allowed at end of R1 or the beging of R2 (default 5bp)
	...
	-s Aligned shift allowed at end of R1 or the beging of R2 (default 5bp)
	-h Help
