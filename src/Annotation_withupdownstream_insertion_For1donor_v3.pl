...
while(<B>){
	...
	print OUT "Si$n\t$id\t$sample\t$string{$id}\t$insertion\t$length\t$ndonor\t$iden\t$fcov\t$fqual\t$chr\t$dstart\t$dend\t$strand\t$annotation\t$dist\t$feature\t$FMstring\t$upjunction\t$downjunction\n";
	print INS ">$id\n$string{$id}\n";
